...
<template>
    <div class="interval-time-select">
        <!-- 日期显示框 -->
        <van-row class="date-select">
            <van-col span="7" :style="{textAlign:'center'}">{{dateTimeInfo['startDate']}}</van-col>
            <van-col span="3" :style="{textAlign:'center',color:'#000'}">至</van-col>
            <van-col
                span="7"
                :style="{textAlign:'center',paddingLeft:'5px'}"
            >{{dateTimeInfo['endDate']}}</van-col>
            <van-col span="7" :style="{textAlign:'right'}" @click.native="screenTime">筛选时间</van-col>
        </van-row>
        <!-- 日历面板 -->
...
export default {
    ...
    methods: {
         ...
         * @Param:
         * @Author: xwq
         * @Date: 2019-10-28 16:18:50
         * @LastEditors: xwq
         * @LastEditTime: Do not edit
         * @return:
         */
        emitHandle(dateInfo) {
            if (this.isOverThreeMonth(dateInfo)) {
                this.dateTimeInfo = dateInfo;
        ...
        /**
         * @Description: 限制日期选择超过三个月
         * @Param:
         * @Author: xwq
         * @Date: 2019-10-28 09:44:03
         * @LastEditors: xwq
         * @LastEditTime: Do not edit
         * @return:
         */
            ...
            this.$watch("popShow", (newVal, oldVal) => {
                if (newVal) {
                    ...
                    if (this.scrollStatus) {
                        this.scrollHandle("active-scroll");
                    }
                } else {
